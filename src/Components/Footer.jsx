...
const Footer = () => {
  return (
    <footer className="w-full bg-gray-100 text-gray-800 py-2">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-6 py-8 px-4 md:px-8">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <ul className="text-gray-700 space-y-1">
            ...
            <li className="hover:text-teal-600 cursor-pointer">Movies</li>
            <li className="hover:text-teal-600 cursor-pointer">Favourites</li>
